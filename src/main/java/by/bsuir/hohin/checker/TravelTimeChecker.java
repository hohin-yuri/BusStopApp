...
public class TravelTimeChecker extends CheckersChain<Bus> implements Checker<Bus> {
    ...
    public Boolean canProvide(List<Bus> buses, Bus bus) {
        ...
        return period <= TimeUnit.HOURS.toMillis(TIME_LIMIT_IN_HOURS) && checkNext(buses, bus);
    }
}
